...
const socials = [
  { label: 'GitHub', url: 'https://github.com/VeetragChoudhary', Icon: GithubIcon }, // 🔧 real handle
...
export const Contact: React.FC = () => {
  return (
    <section id="contact" className="scroll-mt-20">
      ...
      <p className="mt-4 text-lg font-medium leading-snug tracking-[-0.01em] text-slate-800 dark:text-slate-100">
        Open to fullstack roles.
      </p>
      <p className="mt-2 text-[14px] leading-relaxed text-slate-500 dark:text-slate-400">
        If something here fits what you're building, reach out.
      </p>
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        ...
        <a
          ...
          className="glass-soft glass-interactive inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold text-accent"
        >
